...
<form id="form_user_term" action="{{ route('kado.list', ['user_id' => $user_id, 'term_id' => $terms_around['term_current_id']]) }}" method="get">
    ...
    <select name="" id="select_term">
        @foreach ($terms as $term_item)
            @if ($term_item->id == $terms_around['term_current_id'])
