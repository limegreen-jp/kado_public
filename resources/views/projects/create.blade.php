    ...
    <form method="post" action="{{ route('project.store') }}">
        ...
        <div class="card-body">
            ...
            <dl class="project-info">
                ...
                <dd class="project-info-body"><input type="text" id="client_name" name="client_name" class="form-control-full" value="{{ old('client_name') }}"></dd>
            </dl>
            <dl class="project-info">
                <dt class="project-info-title requied"><label for="project_name">案件名</label></dt>
                <dd class="project-info-body"><input type="text" id="project_name" name="project_name" class="form-control-full" value="{{ old('project_name') }}"></dd>
            </dl>
            <dl class="project-info">
                        ...
                        <table class="project-info-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>稼働時間</th>
                                    @foreach ($dates as $date)
                                        <td><input type="number" name="working_times[{{ $date }}]" id="" class="working_time_month" value="{{ old("working_times.".$date."") }}" data-date="{{ $date }}" min=0></td>
                                    @endforeach
                                </tr>
                                <tr>
                                    <th>金額</th>
            ...
            <dl class="project-info">
                ...
                <dd class="project-info-body"><textarea id="description" name="description" class="form-control-full" rows="10">{{ old('description') }}</textarea></dd>
            </dl>
        </div>
